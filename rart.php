        ...
        <div class="container">
            <div class="row service-service">
				...
				<div class="col-lg-4 col-md-6" style="width:300px;height:400px;">
                        ...
                        <h5><a href="rviewproduct.php?cat_id=<?php print $row[0];?>" class="editContent">
                            <?php print $row[1];?></a></h5>
                        <p class="para editContent" style="text-align:justify;"><?php print $row[2];?></p>
                            <a href="rviewproduct.php?cat_id=<?php print $row[0];?>" class="action-button btn mt-3">More Detail <span class="fa fa-angle-double-right"></span></a>
					</div>
                </div>
