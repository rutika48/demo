				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active">
							<a class="nav-link" href="rreg_home.php">Home <span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item @@about__active">
							<a class="nav-link" href="rabout.php">About</a>
						</li>
						<li class="nav-item @@art__active">
							<a class="nav-link" href="rart.php">Art</a>
						</li>
						<li class="nav-item @@vieworder__active">
							<a class="nav-link" href="rvieworder.php">View Order</a>
						</li>
					
						<li class="nav-item @@contactus__active">
							<a class="nav-link" href="rcontactus.php">Contact</a>
						</li>
